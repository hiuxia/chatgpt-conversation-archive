...
5. Click `跳到这里` or a section title to jump
...
1. Update `package.json`, `package-lock.json`, `extension/manifest.json`, `README.md`, and `README.en.md`
2. Generate a new `CHANGELOG` section from commits since the previous tag
3. Run release validation:
   ...
   - `npm run test:zip`
4. Generate these artifacts in [release/](./release):
   - extension zip
   - sha256
   - release notes preview

If you also want the CDP smoke test:
...
4. Packages the extension zip and sha256
5. Builds GitHub Release notes from `CHANGELOG.md`
6. Publishes the GitHub Release and uploads assets
